...
**INHERITED + EXPERIMENTAL.** WORK → QUALIFY → TENDER → AWARD → EXECUTE → VERIFY → SETTLE → LEARN is the product model, not a blanket qualification of autonomous learning.

Retained source: c972256b77b94ec55d2466e961e673b09f5b9e6c, following 0071262a541196d8eccbc4712634333953d903ac. See the original design, qualification, AI operations and economic qualification documents retained alongside this file.
...
For the inherited AI qualification CLI, explicitly configure LABOUR_LLAMA_CLI, LABOUR_GENERAL_MODEL, LABOUR_CODER_SMALL_MODEL and LABOUR_CODER_LARGE_MODEL. Host paths are no longer hard-coded; no model is downloaded. This fork does not rerun the historical AI comparison.
