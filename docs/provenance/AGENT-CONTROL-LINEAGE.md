# Agent Control lineage

Fork date: 24 September 2026.

- Agent Control source: `46442b62099b930b9d694ba4fde1109262f3047f`, published main / annotated v4.15.0.
- Source branch: fix/v4.15-release-gates-20260924 (qualified checkout).
- Tsunora initial history-preserving merge: `5ab3208358a3eba5e0f67bb51106582b9e0538eb`.
- Experimental exchange source: `c972256b77b94ec55d2466e961e673b09f5b9e6c`, feature/v4.15-digital-labour-exchange-20260924. Includes earlier `0071262a541196d8eccbc4712634333953d903ac`.
- Product branch: research/tsunora-0.1. Product version 0.1.0-dev; runtime package remains 4.15.0.

The new repository is an independent local clone with full reachable history and inherited tags, not a renamed worktree. Its source remote is named agent-control-local and push URL is DISABLED. No public Tsunora origin exists.
...
Inherited historical qualifications remain attributed to their original commits and workload bounds. Fresh Tsunora regression and bounded physical qualification are separate evidence. New product branding grants no new runtime authority or production qualification.
